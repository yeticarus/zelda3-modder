...
int FindTargetNearby(int k);//Pokemode
void Probe(int k);
...
void Soldier_Func12Target(int k, int j);//Pokemode
...
void Bumper_Bump(int k); //Pokemode
...
int PlayerFriend_FindTarget(int k, Point16U *pt, bool honeInOnTarget);//Pokemode
