...
void Sprite_ApplySpeedTowardsTarget(int k, int j, uint8 vel);//Pokemode
...
uint8 Sprite_DirectionToFaceTarget(int k, int j, PointU8 *coords_out);//Pokemode
uint8 Sprite_DirectionToFaceLink(int k, PointU8 *coords_out);
PairU8 Sprite_IsRightOfTarget(int k, int j);//Pokemode
PairU8 Sprite_IsRightOfLink(int k);
PairU8 Sprite_IsBelowTarget(int k, int j);//Pokemode
