...
struct Ppu {
  ...
  uint8_t extraLeftCur, extraRightCur, extraLeftRight, extraBottomCur;  //CurrentRightextent, CurrentLeftExtent, total_extent, CurrentBottomExtent
...
void ppu_renderDebugger(Ppu* ppu, int bg, uint offset);//DebugWindow based on tfmoe zelda3-dbg
void ppu_renderPartOfBgLayer(Ppu *ppu, int bg, uint offset, uint xstart, uint linestart, uint xmax);//GuessBehindBlackBorders
